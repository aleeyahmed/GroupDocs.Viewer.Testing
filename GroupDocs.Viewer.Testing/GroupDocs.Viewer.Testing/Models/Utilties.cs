...
namespace GroupDocs.Viewer.Examples
{
    public static class Utilities
    {
        ...
        public const string StoragePath = "C:/GroupDocs/Data/Storage/html";
        public const string OutputHtmlPath = "C:/GroupDocs/Data/Output/html";
        public const string OutputImagePath = "C:/GroupDocs/Data/Output/html";
        public const string OutputPath = "C:/GroupDocs/Data/Output";
        ...
        public static void SaveAsHtml(String filename, String content)
        {
            try
            {
                ...
                String fname = Path.Combine(Path.GetFullPath(OutputHtmlPath), Path.GetFileNameWithoutExtension(filename) + filename.Remove(1) + ".html");
        ...
        public static void SaveAsImage(String imageName, Stream imageContent)
        {
            try
            {
                ...
                img.Save(Path.Combine(Path.GetFullPath(HttpContext.Current.Server.MapPath("~/Content/images/")), Path.GetFileNameWithoutExtension(imageName))+(imageName.Remove(1)) + ".Jpeg", ImageFormat.Jpeg);
                UploadedFiles.myList.Add((Path.GetFileNameWithoutExtension(imageName)) + (imageName.Remove(1)) + ".Jpeg");
                //ExEnd:SaveAsImage
            }
            catch (System.Exception ex)
            {
